...
func _ready():
	...
	# Conectar sinais
	fase1_button.pressed.connect(Callable(self, "_on_fase_1_button_pressed"))
	fase2_button.pressed.connect(Callable(self, "_on_fase_2_button_pressed"))
	fase3_button.pressed.connect(Callable(self, "_on_fase_3_button_pressed"))
...
func _on_fase_1_button_pressed():
	_play_click()
	get_tree().change_scene_to_file("res://scenes/fase_2_1.tscn")
	
func _on_fase_2_button_pressed():
	if unlocked_stage >= 2:
		_play_click()
		get_tree().change_scene_to_file("res://scenes/fase_2_2.tscn")

func _on_fase_3_button_pressed():
	if unlocked_stage >= 3:
		_play_click()
		get_tree().change_scene_to_file("res://scenes/fase_2_3.tscn")
